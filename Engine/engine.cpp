...
void readXML(string file) {
	...
	if (!(xml.LoadFile(("/Users/Asus/Desktop/trabCG/xml/" + file).c_str())) && !(xmltv.LoadFile(("/Users/Asus/Desktop/trabCG/xml/" + file).c_str()))) {  //condicao que carrega o ficheiro e testa se � v�lido
        ...
        while (elemento3 != nullptr) { //boraaaa
			...
			elemento3 = elemento3->NextSiblingElement("model");
